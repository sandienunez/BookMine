...
User.new(email: "girl", password: "happy123").save
User.new(email: "boy", password: "dog123").save 
User.new(email: "dog", password: "fun123").save 
...
Book.new(user_id: 1,book_title:"Pier Giorgio Frassati A Hero of our Times", author: "Cristina Siccardi", book_genre: "Faith", number_of_pages: "354", start: "2020-07-06", end: "2020-07-23", time_one: "09:00", time_two: "18:00", read: false).save
